...
| Assets/RefactRoadMap/QAReports/06_SceneObject_QA.md | Report | SceneObject 1차 QA 종합보고서 | HUD/Fight 1Stage 구조 QA, PlayMode 차단 기록 | 분산된 WorkLog 기록 | 현재 큐는 qa/current.md에서 관리 | 2026-05-31 |
| Assets/RefactRoadMap/QAReports/06_SceneObject_QA.csv | Report | SceneObject 1차 QA 표 데이터 | SO-001~SO-007 상태 | md 리포트 수동 집계 | 현재 큐는 qa/current.md에서 관리 | 2026-05-31 |
