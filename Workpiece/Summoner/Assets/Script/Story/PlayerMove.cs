...
public class PlayerMove : MonoBehaviour
{
    ...
    {
        interactionController.setIsStory(true); // 이동이 끝나면 InteractionController에서 대사 진행을 허용
    }

    public void startNextDialogue()
    {
        interactionController.setIsStory(false); // 이동이 끝나면 InteractionController에서 대사 진행을 허용
    }
